function [tsp_sol, tspDist, trufflesSold, dep_cost] = build_tsp(warehouseID, restLocations, restNames, dayDemand, weekDayStr)
...
%     disp(strcat('The best TSP routing is: ', allOneString))
    ...
    %Plot solution on a map
    plot_map(lat, long, dayDemand, C, warehouseID, weekDayStr, tspDist, trufflesSold, 'modifiedTSP')
